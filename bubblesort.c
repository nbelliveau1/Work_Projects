...
//Params: int a represent an elment to the left of b initially 
//.       int b represents an element to the right a initaly
void swap(int* a, int* b){
    //int a represents the larger number that needs to bubble up
    //int b represents the smaller value that needs to be placed to the left of a
    int temp = *a; 
    *a = *b;   //The memory location of a is set to the memory address of b; a is moving to the right of b
    *b = temp; //The memory location of b is set to the memory address of a which is represented by temp; b is moving to the left of a
}
