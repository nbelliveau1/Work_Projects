...
bst_t* bst_create();
bstnode_t* node_Create(int data); //Addtional function created
int bst_add_helper(bstnode_t* root, int data); //Additional function created
void print_helper(bstnode_t* node, int order); //Additional function created
void bst_free_helper(bstnode_t* n);//Additional function created
